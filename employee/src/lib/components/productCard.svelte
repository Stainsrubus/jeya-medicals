<script lang="ts">
  ...
  export let MRP: number=0;
  export let strikePrice: number=0;
...
>
  ...
  <div class="md:px-4 px-2">
    <!-- Product Name -->
    <h3 class="font-medium md:text-lg text-sm text-[#222222] py-2 capitalize overflow-hidden text-ellipsis whitespace-nowrap">
      {name}
    </h3>
