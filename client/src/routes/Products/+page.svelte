...
<script lang="ts">
    ...
    import ProductCard from '$lib/components/productCard.svelte'; // Reuse your ProductCard component
    ...
    const productsQuery = createQuery<Product[]>({
      ...
      queryFn: async () => {
        ...
        const response = await _axios.get('/products/', {
          params: { limit: 1000, page: 1,userId },
          headers: { 'Content-Type': 'application/json' },
        });
      ...
      <div class="flex  items-center mb-6">
        ...
        <div class="w-1/2 flex">
          <!-- <select
            ...
            class="border rounded-lg p-2 text-[#4F585E]"
          >
          ...
          <div class="w-1/2">
            ...
            <div class="border  py-7 flex w-1/2 rounded-full bg-white p-1">
                ...
                <!-- <button
                  class="ml-4 bg-[#01A0E2] font-medium text-base text-white px-9 py-4 rounded-full hover:bg-[#156aa3] transition-colors duration-200"
                >
                  Search
                </button> -->
          </div>
