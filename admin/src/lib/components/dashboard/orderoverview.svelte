...
<div class="px-4 w-full max-w-[900px] mx-auto">
	<Card.Root class="bg-zinc-100 border-[#6db9ef] border-2 border-solid">
		<Card.Header class="flex justify-between">
			<Card.Title class="flex text-3xl justify-between text-zinc-700">
				...
				<div class="flex gap-2">
					...
					>
						<Select.Trigger class="w-[120px] bg-[#cbe6f8]">
							<span class="capitalize">{selectedFilter}</span>
						</Select.Trigger>
						<Select.Content class='bg-[#cbe6f8]'>
							<Select.Group>
